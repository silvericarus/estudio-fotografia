...
if (isset($_POST["Enviar"])) {
	if(isset($_POST["telefono2"])){
		$consulta2 = "UPDATE clientes SET nombre = '$_POST[nombre]',apellidos= '$_POST[apellidos]',direccion='$_POST[direccion]',telefono1='$_POST[telefono1]',telefono2='$_POST[telefono2]',nick='$_POST[nick]',contraseña='$_POST[pass]' where id = '$userId'";
		...
		$consulta2 = "UPDATE clientes SET nombre = '$_POST[nombre]',apellidos= '$_POST[apellidos]',direccion='$_POST[direccion]',telefono1='$_POST[telefono1]',telefono2=NULL,nick='$_POST[nick]',contraseña='$_POST[pass]' where id = '$userId'";
					...
					<form action="#" method="post" name="editarDatosCliente">
  						<fieldset>
    						<div class="form-group">
      							...
      							<?php echo "<input type=\"text\" name=\"nombre\" id=\"nombre\" class=\"form-control\" value=\"$resul[nombre]\">"; ?>
      							<label for="apellidos">Apellidos</label>
      							<?php echo "<input type=\"text\" name=\"apellidos\" id=\"apellidos\" class=\"form-control\" value=\"$resul[apellidos]\">"; ?>
      							...
      							<?php echo "<input type=\"text\" name=\"nick\" id=\"nick\" class=\"form-control\" value=\"$resul[nick]\">"; ?>
      							<label for="pass">Contraseña</label>
      							<?php echo "<input type=\"text\" name=\"pass\" id=\"pass\" class=\"form-control\" value=\"$resul[contraseña]\">"; ?>
  						</fieldset>
  						<button type="submit" name="Enviar" class="btn btn-light">
