...
<body>
	...
	<div class="content">
		<?php 
			...
			echo "<div class='container'><div class='row'><div class='col-6 offset-3 bg-dark' aria-labelledby='tituloTrabajo'>";
			echo "<img src=\"$resultado[imagen]\" alt=\"$resultado[titulo]\" style='width:inherit;' role='img'><h2 id='tituloTrabajo'>$resultado[titulo]</h2>";
